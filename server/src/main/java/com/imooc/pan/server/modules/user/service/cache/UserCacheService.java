...
public class UserCacheService implements AnnotationCacheService<RPanUser> {
     ...
     * @return
     */
    @Cacheable(cacheNames = CacheConstants.R_PAN_CACHE, keyGenerator = "userIdKeyGenerator", sync = true)
    @Override
     ...
     * @return
     */
    @CacheEvict(cacheNames = CacheConstants.R_PAN_CACHE, keyGenerator = "userIdKeyGenerator")
    @Override
